...
void main()
{
    ...
    GPIO0->OE = 0x3F;  // 6 пинов как выходы
    GPIO0->OUT = 0x3F; // Все выключены
    ...
    print("     6-bit LED Counter (0 to 63)\n");
    print("\n");
    ...
    while (1)
    {
        ...
        /*       GPIO0->OUT ^= 0x00000001;1
              GPIO0->OUT ^= 0x00000002;2
              GPIO0->OUT ^= 0x00000004;3
              GPIO0->OUT ^= 0x00000008;4
              GPIO0->OUT ^= 0x00000010;5
              GPIO0->OUT ^= 0x00000020;4
